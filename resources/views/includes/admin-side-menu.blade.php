            ...
            <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-2-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="/admin/food-items/create">Create New Food Item<span class="badge badge-secondary">New </span></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="submenu-4" class="collapse submenu" style="">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{asset('/admin/users')}}">All Users<span class="badge badge-secondary">New</span></a>
                            </li>
                        </ul>
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a class="nav-link" href="{{asset('/admin/users/create')}}">Create User<span class="badge badge-secondary">New</span></a>
                            </li>
                        </ul>
                    </div>
                </li>
