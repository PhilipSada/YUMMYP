                ...
                <div class="col-sm-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <p class="display-7 font-weight-bold"><span class="text-primary d-inline-block">Estimated Revenue Last 30days {{$estimated_income_last_30}}</span><span class="text-success float-right">+9.45%</span></p>
                        </div>
                    </div>
                </div>
                @endif
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$latestReservation->id}}</td>
                                            <td>
                                                {{$latestReservation->firstname}}  {{$latestReservation->lastname}}
                                            </td>
                                            <td> {{$latestReservation->email}}</td>
                                            <td> {{$latestReservation->phone_number}}</td>
                                            <td> {{$latestReservation->guests_total}}</td>
                                            <td> {{$latestReservation->time}}</td>
                                            <td>{{date('m/d/y', strtotime($latestReservation->updated_at))}}</td>
                                        </tr>
                                       @endforeach
